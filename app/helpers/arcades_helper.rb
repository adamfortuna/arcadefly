module ArcadesHelper
  ...
  def favorite_arcade_link(arcade, options = {})
    ...
    link_to_remote(image_tag("http://s3.amazonaws.com/arcadefly/images/icons/joystick_add.png", :size => "16x16", :border => 0) + text, 
  ...
  def unfavorite_arcade_link(arcade, options = {})
    ...
    text = options[:show_text] ? " " + options[:text] : ''
    link_to_remote(image_tag("http://s3.amazonaws.com/arcadefly/images/icons/joystick_delete.png", :size => "16x16", :border => 0) + text, 
