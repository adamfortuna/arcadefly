...
Rails::Initializer.run do |config|
  ...
  config.gem 'rspec',                   :lib => false,            :source => 'http://gems.rubyforge.org/', :version => '~>1.1.12'
  config.gem 'rspec-rails',             :lib => false,            :source => 'http://gems.rubyforge.org/', :version => '~>1.1.12'
